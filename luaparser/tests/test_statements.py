...
class StatementsTestCase(tests.TestCase):
    ...
    def test_for_in_1(self):
        ...
        self.assertEqual(nodes[2].tokens[0].value.text, 'for')
        self.assertEqual(nodes[2].tokens[1].value.text, ' ')
        self.assertEqual(nodes[2].tokens[2].value.text, 'k')
        self.assertEqual(nodes[2].tokens[3].value.text, ',')
        self.assertEqual(nodes[2].tokens[4].value.text, ' ')
        self.assertEqual(nodes[2].tokens[5].value.text, 'v')
        self.assertEqual(nodes[2].tokens[6].value.text, ' ')
        self.assertEqual(nodes[2].tokens[7].value.text, 'in')
        self.assertEqual(nodes[2].tokens[8].value.text, ' ')
        self.assertEqual(nodes[2].tokens[9].value.text, 'pairs')
        ...
        self.assertEqual(nodes[2].tokens[15].value.text, 'do')
        self.assertEqual(nodes[2].tokens[16].value.text, '\n')
        self.assertEqual(nodes[2].tokens[17].value.text, '  ')
        self.assertEqual(nodes[2].tokens[18].value.text, 'print')
        self.assertEqual(nodes[2].tokens[19].value.text, '(')
        self.assertEqual(nodes[2].tokens[20].value.text, 'k')
        self.assertEqual(nodes[2].tokens[21].value.text, ',')
        self.assertEqual(nodes[2].tokens[22].value.text, ' ')
        self.assertEqual(nodes[2].tokens[23].value.text, 'v')
        self.assertEqual(nodes[2].tokens[24].value.text, ')')
        ...
        self.assertEqual(nodes[5].tokens[0].value.text, 'pairs')
        ...
        self.assertEqual(nodes[8].tokens[0].value.text, 'print')
        self.assertEqual(nodes[8].tokens[1].value.text, '(')
        self.assertEqual(nodes[8].tokens[2].value.text, 'k')
        self.assertEqual(nodes[8].tokens[3].value.text, ',')
        self.assertEqual(nodes[8].tokens[4].value.text, ' ')
        self.assertEqual(nodes[8].tokens[5].value.text, 'v')
    ...
    def test_if_elseif_elseif_else(self):
        ...
        self.assertEqual(nodes[2].tokens[0].value.text, 'if')
        self.assertEqual(nodes[2].tokens[1].value.text, ' ')
        self.assertEqual(nodes[2].tokens[2].value.text, 'true')
        self.assertEqual(nodes[2].tokens[3].value.text, ' ')
        self.assertEqual(nodes[2].tokens[4].value.text, 'then')
        self.assertEqual(nodes[2].tokens[5].value.text, '\n')
        self.assertEqual(nodes[2].tokens[6].value.text, 'elseif')
        self.assertEqual(nodes[2].tokens[7].value.text, ' ')
        self.assertEqual(nodes[2].tokens[8].value.text, 'false')
        self.assertEqual(nodes[2].tokens[9].value.text, ' ')
        self.assertEqual(nodes[2].tokens[10].value.text, 'then')
        self.assertEqual(nodes[2].tokens[11].value.text, '\n')
        self.assertEqual(nodes[2].tokens[12].value.text, 'elseif')
        self.assertEqual(nodes[2].tokens[13].value.text, ' ')
        self.assertEqual(nodes[2].tokens[14].value.text, '42')
        self.assertEqual(nodes[2].tokens[15].value.text, ' ')
        self.assertEqual(nodes[2].tokens[16].value.text, 'then')
        self.assertEqual(nodes[2].tokens[17].value.text, '\n')
        self.assertEqual(nodes[2].tokens[18].value.text, 'else')
        self.assertEqual(nodes[2].tokens[19].value.text, '\n')
        self.assertEqual(nodes[2].tokens[20].value.text, '  ')
        self.assertEqual(nodes[2].tokens[21].value.text, 'return')
        self.assertEqual(nodes[2].tokens[22].value.text, ' ')
        self.assertEqual(nodes[2].tokens[23].value.text, 'true')
        self.assertEqual(nodes[2].tokens[24].value.text, '\n')
        self.assertEqual(nodes[2].tokens[25].value.text, 'end')

        self.assertIsInstance(nodes[3], ElseIf)
        self.assertEqual(nodes[3].tokens[0].value.text, 'elseif')
        self.assertEqual(nodes[3].tokens[1].value.text, ' ')
        self.assertEqual(nodes[3].tokens[2].value.text, 'false')
        self.assertEqual(nodes[3].tokens[3].value.text, ' ')
        self.assertEqual(nodes[3].tokens[4].value.text, 'then')

        self.assertIsInstance(nodes[4], ElseIf)
        self.assertEqual(nodes[4].tokens[0].value.text, 'elseif')
        self.assertEqual(nodes[4].tokens[1].value.text, ' ')
        self.assertEqual(nodes[4].tokens[2].value.text, '42')
        self.assertEqual(nodes[4].tokens[3].value.text, ' ')
        self.assertEqual(nodes[4].tokens[4].value.text, 'then')
    ...
    def test_label(self):
        ...
        self.assertEqual(nodes[2].tokens[1].value.text, 'foo')
    ...
    def test_goto(self):
        ...
        self.assertEqual(nodes[2].tokens[0].value.text, 'goto')
        self.assertEqual(nodes[2].tokens[1].value.text, ' ')
