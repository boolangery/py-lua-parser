...
class ExpressionsTestCase(tests.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertEqual(nodes[3].tokens[0].value.text, '1')
        ...
        self.assertEqual(nodes[3].tokens[4].value.text, '0.2')

        self.assertIsInstance(nodes[4], Number)
        self.assertEqual(nodes[4].tokens[0].value.text, '0.2')

        self.assertIsInstance(nodes[5], Number)
        self.assertEqual(nodes[5].tokens[0].value.text, '1')
    ...
    def test_length_op(self):
        ...
        self.assertEqual(nodes[3].tokens[1].value.text, 't')
    ...
    def test_dict(self):
        ...
        self.assertEqual(nodes[3].tokens[0].value.text, '{')
        self.assertEqual(nodes[3].tokens[1].value.text, 'foo')
        self.assertEqual(nodes[3].tokens[2].value.text, ' ')
        self.assertEqual(nodes[3].tokens[3].value.text, '=')
        self.assertEqual(nodes[3].tokens[4].value.text, ' ')
        self.assertEqual(nodes[3].tokens[5].value.text, '"bar"')
        self.assertEqual(nodes[3].tokens[6].value.text, ',')
        self.assertEqual(nodes[3].tokens[7].value.text, ' ')
        self.assertEqual(nodes[3].tokens[8].value.text, 'bar')
        self.assertEqual(nodes[3].tokens[9].value.text, ' ')
        self.assertEqual(nodes[3].tokens[10].value.text, '=')
        self.assertEqual(nodes[3].tokens[11].value.text, ' ')
        self.assertEqual(nodes[3].tokens[12].value.text, '"foo"')
        self.assertEqual(nodes[3].tokens[13].value.text, '}')
    ...
    def test_function_def_anonymous(self):
        ...
        self.assertEqual(nodes[3].tokens[0].value.text, 'function')
        self.assertEqual(nodes[3].tokens[1].value.text, '(')
        self.assertEqual(nodes[3].tokens[2].value.text, ')')
        self.assertEqual(nodes[3].tokens[3].value.text, ' ')
        self.assertEqual(nodes[3].tokens[4].value.text, 'local')
        self.assertEqual(nodes[3].tokens[5].value.text, ' ')
        self.assertEqual(nodes[3].tokens[6].value.text, 'a')
        self.assertEqual(nodes[3].tokens[7].value.text, ' ')
        self.assertEqual(nodes[3].tokens[8].value.text, 'end')
