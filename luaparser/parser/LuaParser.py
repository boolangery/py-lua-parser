...
class LuaParser ( Parser ):
    ...
    class Repeat_statContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitRepeat_stat" ):
                return visitor.visitRepeat_stat(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Goto_statContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitGoto_stat" ):
    ...
    class Elseif_statContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitElseif_stat" ):
                return visitor.visitElseif_stat(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Table_constructorContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTable_constructor" ):
                return visitor.visitTable_constructor(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Field_sepContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitField_sep" ):
                return visitor.visitField_sep(self)
            else:
                return visitor.visitChildren(self)
